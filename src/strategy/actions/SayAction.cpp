        ...
        default:
        {
            ...
            case 1:
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    msg = "不，但 " + word[verb_pos + 1] + " 会再次 " + word[verb_pos + 3] + " 的，%s";
                    break;
                case 3:
                    msg = "恐怕那是在我出现之前或者我没注意的时候";
                    break;
            ...
            case 2:
            {
                ...
                {
                case 0:
                    msg = "这是真的，" + word[verb_pos + 1] + " " + word[verb_pos] + " " + word[verb_pos + 2] + " " + word[verb_pos + 3] + " " + word[verb_pos + 4] + " " + word[verb_pos + 5];
                    break;
                case 1:
                    msg = "是的 %s，确实如此";
                    break;
    ...
    else if (!found)
    {
        ...
        case 1:
        {
            ...
            case 1:
                ...
                break;
            case 2:
                msg = word[verb_pos ? verb_pos - 1 : verb_pos + 1] + " 会再次 " + word[verb_pos + 1] + " 的，%s";
                break;
            }
            msg = std::regex_replace(msg, std::regex("%s"), name);
            respondsText = msg;
